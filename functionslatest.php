...
//Add image URL to rest response //
function add_image_url_to_rest_response($data, $post, $request) {
  if ($post->post_type === 'weekly_inspiration') {
...
add_filter('rest_prepare_weekly_inspiration', 'add_image_url_to_rest_response', 10, 3);
//Add image URL to rest response //
